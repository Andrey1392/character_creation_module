...
def start_training(character):
    ...
    # # game_classes = {Warrior:'warrior', Mage:'mage', Healer:'healer'}
    # # char_name: Character = game_classes[character.__class__.__name__]
    # character_decription = {'Warrior': ('warrior', 'ты Воитель — великий мастер ближнего боя.'),
    #                         'Mage': ('mage', 'ты Маг — превосходный укротитель стихий.'), 
    #                         'Healer': ('healer', 'ты Лекарь — чародей, способный исцелять раны.')}
    # char_name = character.__class__.__name__
    
    # print(f'{character_decription[char_name][0]}, {character_decription[char_name][1]}')
    ...
    cmd = None
    action_dict = {'attack':character.attack(),
    ...
    while cmd != 'skip':
        ...
        if cmd in action_dict.keys():
            print(action_dict[cmd])
